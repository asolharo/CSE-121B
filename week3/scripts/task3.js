...
document.querySelector('#sumOfArray').innerHTML = numbers.reduce((subSum, a) => subSum + a, 0)
...
let doubledNum = numbers.map(x => x * 2)
document.querySelector('#sumOfMultiplied').innerHTML = doubledNum.reduce((subSum, a) => subSum + a, 0)
